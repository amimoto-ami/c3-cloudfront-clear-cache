...
class Options_Service {
    ...
    public function get_options() {
        ...
        if ( $this->env->is_amimoto_managed() ) {
            return $this->hook_service->apply_filters( $filter_name, array(
        ...
        if ( $options ) {
            if ( isset( $options['distribution_id'] ) ) $results['distribution_id'] = $options['distribution_id'];
            if ( isset( $options['access_key'] ) ) $results['access_key'] = $options['access_key'];
            if ( isset( $options['secret_key'] ) ) $results['secret_key'] = $options['secret_key'];
        }
